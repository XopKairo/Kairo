...
typedef NS_ENUM(NSUInteger, ZIMMessagePinStatus) {
...
typedef NS_ENUM(NSInteger, ZIMConversationSearchMode) {
...
typedef NS_ENUM(NSUInteger, ZIMConversationPinnedFilter) {
...
@interface ZIMTipsMessagePinStatusChangeInfo : ZIMTipsMessageChangeInfo
...
@property (nonatomic, copy, readonly) NSString *pinnedUserID;

@property (nonatomic, assign, readonly) long long pinnedTime;
...
@property (nonatomic, strong) NSArray<ZIMMessageLiteInfo *> *messageInfoList;
@property (nonatomic, strong) NSArray<NSNumber *> *failedIndexList;
...
@property (nonatomic, assign) BOOL isAllowMultipleMessagePartialFailed;
...
@interface ZIMMessagePinStatusChangeInfo : NSObject

@property (nonatomic, assign) ZIMMessagePinStatus pinStatus;
...
@property (nonatomic, assign) long long pinnedTime;
...
@property (nonatomic, assign) ZIMConversationPinnedFilter pinnedFilter;
...
@property (nonatomic, assign) ZIMConversationSearchMode mode;
...
@interface ZIMGroupListQueryConfig : NSObject
...
typedef void (^ZIMMessagePinnedCallback)(ZIMError *errorInfo);

typedef void (^ZIMPinnedMessageListQueriedCallback)(NSArray<ZIMMessage *> *messageList,
                                                    ZIMError *errorInfo);
...
typedef void (^ZIMGroupListQueriedCallback)(NSArray<ZIMGroup *> *groupList, long long nextFlag,
                                            ZIMError *errorInfo);
