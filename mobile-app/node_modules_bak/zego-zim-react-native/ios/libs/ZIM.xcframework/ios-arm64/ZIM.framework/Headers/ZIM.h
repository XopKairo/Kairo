...
- (void)pinMessage:(ZIMMessage *)message
          isPinned:(BOOL)isPinned
          callback:(ZIMMessagePinnedCallback)callback
    // clang-format off
NS_SWIFT_NAME(pinMessage(_:isPinned:callback:));
// clang-format on

- (void)queryPinnedMessageListByConversationID:(NSString *)conversationID
                              conversationType:(ZIMConversationType)conversationType
                                      callback:(ZIMPinnedMessageListQueriedCallback)callback
    // clang-format off
NS_SWIFT_NAME(queryPinnedMessageList(by:conversationType:callback:));
// clang-format on
...
- (void)queryGroupListWithCount:(unsigned int)count
                         config:(ZIMGroupListQueryConfig *)config
                       callback:(ZIMGroupListQueriedCallback)callback;
