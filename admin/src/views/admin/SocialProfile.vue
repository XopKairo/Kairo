...
const fetchSocialLinks = async () => {
  try {
    const res = await axios.get(`${import.meta.env.VITE_API_URL}/admin/social-profile`);
...
const updateSocialLinks = async () => {
  try {
    await axios.post(`${import.meta.env.VITE_API_URL}/admin/social-profile`, socialLinks.value);
